...
const logger = (0, winston_1.createLogger)({
    ...
    transports: [
        ...
        new winston_daily_rotate_file_1.default({
            filename: path_1.default.join(process_1.default.cwd(), 'logs', 'winston', 'success', 'UMS-%DATE%-success.log'),
...
const errorlogger = (0, winston_1.createLogger)({
    ...
    transports: [
        new winston_1.transports.Console(),
        new winston_daily_rotate_file_1.default({
            filename: path_1.default.join(process_1.default.cwd(), 'logs', 'winston', 'errors', 'UMS-%DATE%-errors.log'),
            datePattern: 'YYYY-MM-DD-HH',
            zippedArchive: true,
            maxSize: '20m',
            maxFiles: '14d',
